...
const renderMenu = (menu) => {
    ...
    menu.forEach((item) => cardsWrapper.insertAdjacentHTML("beforeend", `<div class="card">
...
scrollToTopBtn === null || scrollToTopBtn === void 0 ? void 0 : scrollToTopBtn.addEventListener("click", handleScrollToTop);
